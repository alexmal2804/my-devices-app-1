        ...
        <Box sx={{ flex: 1, overflow: 'auto', p: 3 }}>
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary">
              Поддерживаемые форматы: PDF (ограниченно), DOCX, XLSX, CSV, TXT
            </Typography>
            <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
              Максимальный размер файла: 10 МБ. Для лучшего качества RAG
              рекомендуется DOCX или TXT
            </Typography>
            ...
            >
              ...
              error.includes('Database tables not created') ? (
                <Box>
                  ...
                  <Typography variant="body2" sx={{ mb: 1 }}>
                    Необходимо создать таблицы в Supabase. Следуйте инструкции:
                  </Typography>
                  <Typography
                    variant="body2"
                  ...
                  >
                    ...
                    <br />
                    2. Выполните скрипт из файла supabase_tables.sql
                    <br />
